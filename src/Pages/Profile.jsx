...
{errMsg && <p className="bg-red-300 text-red-950">{errMsg}</p>}
  ...
  <h1>Upload Profile Photo</h1>
      <form onSubmit={handleSubmitPhoto} className="space-y-4">
        <div>
          {/* Button instead of label to avoid accidental submit */}
          <button
            type="button"
            onClick={() => fileInput.current.click()}
            className="cursor-pointer text-gray-600 hover:text-blue-600 transition duration-200 flex items-center space-x-2"
          >
